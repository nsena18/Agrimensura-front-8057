...
class Modal extends Component {
    ...
    modalVars() {
        ...
        if (action == "CREATE") {
            ...
            return {
                ...
                successMessage: "El Estado ha sido editado con éxito.",
                saveButton: true,
                saveButtonLabel: "Guardar",
                buttonClass: "",
                disabled: false,
    ...
    render() {
        ...
        return (
            <ParadigmaModal
                getUrl={(vars.get ? api.expedientes.estadolotes : null)}
                submitUrl={(vars.submitType ? api.expedientes.estadolotes : null)}
