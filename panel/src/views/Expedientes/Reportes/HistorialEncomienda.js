                    ...
                    <Col className="col-12">
                        <Card body className="border-0 p-0 mb-3">
                            ...
                            <CardBody>
                                <Row>
                                    <Col className="col-12 col-md-4 col-lg-4">
                                        {/* <ParadigmaLabeledInput
                                            label="Período"
                                            md={[3, 9]}
                                            // classNames={['repFiltroLbl','']}
                                            inputComponent={
                                                <Row>
                                                    <Col className="col-6 col-md-12 col-lg-12 col-xl-6 mb-0 mb-md-1 mb-xl-0 pr-1">
                                                        <ParadigmaDatePicker fieldName={"fechaInicio"}
                                                            datetime={false}
                                                            placeholder={"Desde"}
                                                            icon={"fa fa-calendar"}
                                                            value={desde}
                                                            className={'repFechaInp'}
                                                    ...
                                                    <Col className="col-6 col-md-12 col-lg-12 col-xl-6 pl-1">
                                                        <ParadigmaDatePicker fieldName={"fechaFin"}
                                                            datetime={false}
                                                            placeholder={"Hasta"}
                                                            icon={"fa fa-calendar"}
                                                            value={hasta}
                                                            className={'repFechaInp fhasta'}
                                                            onChange={data => this.setState(prevState => ({
                                                                filtros: {
                                                                    ...prevState.filtros,
                                                                    hasta: data
                                ...
                                {/* Nomenclatura */}
                                <Row>
                                    <Col className="col-6 col-md-2 col-lg-2">
                                        <ParadigmaLabeledInput
                                            label="Cric."
                                            md={[4, 8]}
                                            ...
                                            onChange={data => this.setState(prevState => ({
                                                filtrosNomenclatura: {
                                                    ...prevState.filtrosNomenclatura,
                                                    circunscripcion: data.target.value
                                                }
                                            }), this.setEncomienda(null))}
                                        />
                                    </Col>
