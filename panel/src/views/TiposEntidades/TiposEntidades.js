                ...
                buttons={[
                    {
                        ...
                        permission: 'tiposentidades_new',
                    },
                    {
                        edit: true,
                        component: (props) => <Modal {...props} action="EDIT" />,
                        permission: 'tiposentidades_edit',
                    },
                    {
                        edit: true,
                        component: (props) => <Modal {...props} action="DETAIL" />,
                        permission: 'tiposentidades_detail',
                    },
                    {
                        edit: true,
                        component: (props) => <Modal {...props} action="DELETE" />,
                        permission: 'tiposentidades_delete',
                    },
                ]}
                apiUrl={api.comitentes.tiposEntidades}
