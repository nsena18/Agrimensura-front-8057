...
class Modal extends Component {
    ...
    modalVars() {
        ...
        if (action == "CREATE") {
            return {
                ...
                successMessage: "La Profesion ha sido creada con éxito.",
                saveButton: true,
            ...
            return {
                ...
                successMessage: "La Profesion ha sido editada con éxito.",
                saveButton: true,
                saveButtonLabel: "Guardar",
                buttonClass: "",
                disabled: false,
            ...
            return {
                ...
                successMessage: "La Profesion ha sido eliminada con éxito.",
                saveButton: true,
    ...
    render() {
        ...
        return (
            <ParadigmaModal
                getUrl={(vars.get ? api.comitentes.profesiones : null)}
                submitUrl={(vars.submitType ? api.comitentes.profesiones : null)}
