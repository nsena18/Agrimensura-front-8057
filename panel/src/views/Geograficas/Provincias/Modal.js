...
class Modal extends Component {
    ...
    modalVars() {
        ...
        if (action == "CREATE") {
            ...
            return {
                ...
                successMessage: "La Provincia ha sido eliminada con éxito.",
                saveButton: true,
    ...
    render() {
        ...
        return (
            <ParadigmaModal
                getUrl={(vars.get ? api.geograficas.provincias : null)}
                submitUrl={(vars.submitType ? api.geograficas.provincias : null)}
