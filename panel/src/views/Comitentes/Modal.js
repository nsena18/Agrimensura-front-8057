...
class Modal extends Component {
    ...
    modalVars() {
        ...
        if (action == "CREATE") {
            return {
                get: false,
                submitType: "POST",
                title: "Nuevo Comitente",
                buttonTitle: "Nuevo",
                danger: false,
                buttonIcon: "fa fa-plus fa-lg",
                showConfirmationMessages: true,
                successMessage: "El Comitente ha sido creado con éxito. Usuario y Contraseña: "+userPass,
                saveButton: true,
            ...
            return {
                ...
                showConfirmationMessages: false,
            ...
            return {
                get: true,
                submitType: "DELETE",
                title: "Eliminar Comitente",
                buttonTitle: "Eliminar",
                danger: true,
                buttonIcon: "fa fa-trash fa-lg",
                showConfirmationMessages: false,
                // successMessage: "El Comitente ha sido eliminado con éxito.",
                successMessage: "",
                saveButton: true,
    ...
    onValidation = () => {
        ...
        if ((email==null) || ((email.indexOf("@") == -1) || (email.indexOf(".") == -1) || (email.indexOf("@") > email.lastIndexOf(".")) || (email.lastIndexOf(".") == email.length-1))){
    ...
    render() {
        ...
        return (
            <ParadigmaModal
                ...
                submitUrl={(vars.submitType ? api.comitentes.comitentes : null)}
