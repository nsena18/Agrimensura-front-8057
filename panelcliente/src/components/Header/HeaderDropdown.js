...
import PerfilComitente from '../../views/PerfilComitente/PerfilComitente'
        ...
        return (
            <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
                ...
                <DropdownMenu right>
                    ...
                    <PerfilComitente onOpen={() => this.setState({ PerfilOpen: true })} onClose={() => this.setState({ PerfilOpen: false })} action={'EDIT'} />
