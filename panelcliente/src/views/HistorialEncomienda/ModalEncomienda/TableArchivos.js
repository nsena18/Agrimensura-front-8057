...
class ModalArchivos extends Component {
    ...
    render() {
        ...
        const { action, disabled, row, value } = this.props;
            ...
            <Fragment>
                { !disabled &&
                    <Button
                        ...
                        disabled={((action === 'download' && ((row === null) || (value!=null && value.bloqueado!=true))) || ((action === 'delete') && ((row === null) || (value!=null && value.bloqueado==true)))) }
                    >
